    ...
    <div class="wrapper">
                ...
                <div class="navigation navigation-top clearfix">
                    <ul>
                        ...
                        <?php
                            ...
                            {
                                ?>
                              <li><a href="login.php" ><i class="icon icon-user"></i></a></li>  
                            <?php }   
                         ?>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="cart-block cart-block-item clearfix">
                                    ...
                                    <div class="price">
                                        <span class="final">Rs. 10.998</span>
                                        <span class="discount">Rs 20.666</span>
                                    </div>
                                    <!--delete-this-item-->
                                    <span class="icon icon-cross icon-delete"></span>
                                </div>
                                ...
                                <div class="cart-block cart-block-item clearfix">
                                    ...
                                    <div class="price">
                                        <span class="final">Rs.10.000</span>
                                        <span class="discount">Rs. 30.000</span>
                                    </div>
                                    <!--delete-this-item-->
                                    <span class="icon icon-cross icon-delete"></span>
                                </div>
                            ...
                            <div class="clearfix">
                                <div class="cart-block cart-block-footer clearfix">
                                    ...
                                    <div>
                                        <div class="h4 title">Rs. 12.5000</div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="header-content">
            ...
            <div class="owl-slider">
                ...
                <div class="item" style="background-image:url(assets/images/gallery-1.jpg)"; brightness(50%) >
                    <div class="box">
                        <div class="container">
                            <h2 class="title animated h1" data-animation="fadeInDown">Modern furniture</h2>
                            <div class="animated" data-animation="fadeInUp">
                                Modern & durable furniture <br /> Clean design &
                                layout. Engineered material
                            </div>
                ...
                <div class="item" style="background-image:url(assets/images/gallery-2.jpg)">
                    <div class="box">
                        <div class="container">
                            <h2 class="title animated h1" data-animation="fadeInDown">Exceptional handcrafted objects to connoisseurs everywhere</h2>
                            <div class="animated" data-animation="fadeInUp">Unlimited Choices. Unbeatable Prices. Free Shipping.</div>
                            <div class="animated" data-animation="fadeInUp">International Furniture category</div>
                    ...
                    <div class="box">
                        <div class="container">
                            ...
                            <div class="desc animated" data-animation="fadeInUp">
                                Quality, innovation and respect for the environment are also our main objective
                            </div>
                            <div class="desc animated" data-animation="fadeInUp">
                        ...
                        <article>
                            <div class="info">
                                <span class="add-favorite added">
                                    <a href="php.php" data-title="Add to favorites" data-title-added="Added to favorites list"><i class="icon icon-heart"></i></a>
                                </span>
                                <span>
                        ...
                        <article>
                            <div class="info">
                                <span class="add-favorite">
                                    <a href="login.php" data-title="Add to favorites" data-title-added="Added to favorites list"><i class="icon icon-heart"></i></a>
                                </span>
                                <span>
                                    <a href="#productid1" class="mfp-open" data-title="Quick wiew"><i class="icon icon-eye"></i></a>
                                </span>
                            ...
                            <div class="figure-grid">
                                <div class="image">
                                    <a href="#productid1" class="mfp-open">
                                        <img src="assets/images/paul-weaver-nWidMEQsnAQ-unsplash.jpg" alt="" width="360" />
                                    </a>
                                </div>
                                <div class="text">
                    ...
                    <div class="product">
                        ...
                        <div class="popup-table">
                            <div class="popup-cell">
                                <div class="price">
                                    <span class="h3">Rs. 25.000<small>Rs. 29.000</small></span>
                                </div>
                            </div>
                            <div class="popup-cell">
        ...
        <footer>
            <div class="container">
                ...
                <div class="footer-social">
                    <div class="row">
                        <div class="col-sm-6">
                             <a href="#">Privacy policy</a> &nbsp &nbsp <a href="#">Designed by PaiTechCo</a>
                        </div>
